        ...
        <div className="max-w-md w-full p-6">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                className="w-full font-bold bg-sky-400 text-white p-2 rounded-md hover:bg-sky-300 focus:outline-none"
              >
                {!isLoading ? (
                  "Login"
                ) : (
          ...
          <button
            ...
            className="mt-4 font-bold w-full bg-sky-700 text-white p-2 rounded-md hover:bg-sky-800"
          >
            Register
          </button>
        </div>
