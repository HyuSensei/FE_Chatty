...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    try {
      e.preventDefault();
      if (!checkIsVaild()) return;
      setIsloading(true);
      const res = await axios.post(API_URL + "/register", input);
      if (res.data.success) {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="w-full bg-gradient-to-r from-indigo-100 to-indigo-300 lg:w-1/2 flex items-center justify-center">
        <div className="max-w-md w-full p-6">
          <div className="flex gap-2 items-center justify-center cursor-pointer py-2">
            <svg
              fill="#5bc0de"
              height="40px"
              width="40px"
            ...
            <span className="font-bold text-2xl text-logo">Chatty</span>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="pt-4 flex justify-between gap-4">
                <div className="py-3 px-3 flex items-center gap-4 bg-white rounded-md w-1/2">
                  <input
                    defaultChecked
                    value={"male"}
                    onChange={(e) => {
            ...
            <button
              disabled={isLoading}
              type="submit"
              className="mt-4 font-bold w-full bg-sky-700 text-white p-2 rounded-md hover:bg-sky-800 focus:bg-sky-950"
            >
              {!isLoading ? (
                "Register"
              ) : (
                <span className="pt-4 loading loading-spinner"></span>
              )}
            </button>
            <div className="mt-4 text-sm text-gray-600 text-center font-bold">
              <p>
                ...
                <span
                  ...
                  className="text-sky-700 text-md underline cursor-pointer"
                >
                  Login
                </span>
              </p>
